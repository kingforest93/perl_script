...
#
# Syntax:
# CreateScaffoldedFasta_lachesis.pl <assembly-fasta-file> <OUTPUT_DIR>
#
# Inputs:
# -- Assembly fasta file.
...
my $assembly_fasta = "./assembly.fasta";
my $output_dir = ".";
...
if ( scalar @ARGV == 2 ) {
	...
	die("Usage: CreateScaffoldedFasta_lachesis.pl input.fasta output_dir\n");
}



print localtime(). ": CreateScaffoldedFasta_lachesis.pl with input fasta = $assembly_fasta, OUTPUT_DIR = $output_dir\n";
